...
if (is_object($uo)) { 
	...
	<input type="hidden" name="_disableLogin" value="1">
		...
		<table class="table" border="0" cellspacing="0" cellpadding="0" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td width="35%"><?=t('First Name')?> <span class="required">*</span></td>
                    <td width="35%"><?=t('Last Name')?> <span class="required">*</span></td>
                </tr>
                <tr>
                    <td><input type="text" name="fName" autocomplete="off" value="<?=$uo->getFirstName()?>" style="width: 95%"></td>
                    <td><input type="text" name="lName" autocomplete="off" value="<?=$uo->getLastName()?>" style="width: 95%"></td>
                </tr>
            </tbody>
		</table>
	...
	<div class="ccm-pane-options">
		...
		<? } ?>
            <?php if ($uo->getFullName()) { ?>
                <p><b><?=t('Full Name')?> :</b> <?= $uo->getFullName() ?></p>
            <?php } ?>
