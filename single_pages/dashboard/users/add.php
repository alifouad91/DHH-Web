	...
	<div class="ccm-pane-body">
    	...
    	<table class="table table-bordered">
            ...
            <tbody>
            	...
            	<tr>
                    <td><?php echo t('First Name')?> <span class="required">*</span></td>
                    <td><?php echo t('Last Name')?> <span class="required">*</span></td>
                </tr>
                <tr>
					<td><input type="text" name="fName" autocomplete="off" value="<?php echo $th->entities($_POST['fName'])?>" style="width: 95%"></td>
					<td><input type="text" autocomplete="off" name="lName" value="<?php echo $th->entities($_POST['lName'])?>" style="width: 95%"></td>
				</tr>
                <tr>
