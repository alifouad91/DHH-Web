...
class DashboardUtilitiesPaymentBillsController extends DashboardBaseController
{

    protected $configURL   = 'dashboard/utilities/payment_bills';
    ...
    public function add_save()
    {
        ...
        $desc        = $th->sanitize($this->post('description'));
...
//            $e->add('Image is required');
        ...
        if (!$e->has()) {
            $bill            = Bill::add($pID, $amount, self::TYPE, $desc, null, null, $date);
...
//            $e->add('Image is required');
            ...
            if (!$e->has()) {
                ...
                $bill->update($pID, $amount, $type, $desc, null, $image, $date);
