...
<div id="formidable_container_<?php  echo $ff->formID ?>" class="ant-form  formidable <?php  echo $review?'review':'' ?> <?php  echo $limit_submission?'limit_submission':'' ?> <?php  echo $submission?'submission':'' ?> <?php  echo $schedule?'schedule':'' ?> <?php  echo $error?'error':'' ?>">
					...
					<div class="">
						...
						<?php 
                            ...
                            foreach($row as $layoutID => $layout) { ?>
                                <div class="ant-row ant-form-item <?php  echo ($i==(count($row)-1)?' last':''); ?> <?php  echo 'w'.$width; ?>">
                                    <div class="ant-form-item-control-wrapper">
									<?php  
                                        ...
                                        if(count($layout->elements)) {
                                            foreach($layout->elements as $element) { ?>														
                                                ...
                                                <?php  } else { ?>
                                                	<div class="ant-form-item-control default-active element <?php  echo $element->element_type; ?> <?php  echo $element->handle; ?>">
														<?php  if (intval($element->label_hide) == 0) { ?>
                                                            <div class="ant-form-item-label default-active">
                                                        ...
                                                        <?php  } ?>
                                                        <span class="ant-form-item-children <?php  echo intval($element->label_hide)==0?'has_label':'no_label'; ?>">
                                                            <?php  if ($review) { ?>
                                                        ...
                                                        <?php  if (intval($element->option_other) != 0 && !$review) { ?>																	
                                                            <span class="input ant-form-item-children <?php  echo intval($element->label_hide)==0?'has_label':'no_label'; ?> option_other">													
                                                        ...
                                                        <?php  if (intval($element->confirmation) != 0 && !$review) { ?>																	
                                                            ...
                                                            <?php  } ?>
                                                            <span class="input ant-form-item-children <?php  echo intval($element->label_hide)==0?'has_label':'no_label'; ?>">													
					...
					<div class="element">
						<div id="ff_buttons" class="buttons">
							...
							{ 
								...
								echo $form->submit('submit', $text->specialchars($ff->submit_button_label), array(), 'ant-btn ant-btn-primary');
							} ?>
