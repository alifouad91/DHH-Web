...
<style>
    ...
    ul li.ccm-file-selected-wrapper {
...
<ul style="list-style-type: none; margin: 0;" id="ak<?php echo $this->attributeKey->getAttributeKeyID() ?>_attachedFilesList">
<?php
if (is_object($this->attributeValue)){
    ...
    foreach ($multiFilesValueObj as $image) {
		...
		?>
		<li class="ccm-file-selected-wrapper" style="clear:both;" id="ak<?php echo $this->attributeKey->getAttributeKeyID() ?>_fileAttachmentRow<?php echo  $file->getFileID() ?>">
...
<script>
$(document).ready(function(){$( "#ak<?php echo $this->attributeKey->getAttributeKeyID() ?>_attachedFilesList" ).sortable();});
</script>