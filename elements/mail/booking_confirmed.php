    ...
    <tr>
      <td height="67">
        <p style="
          ...
          line-height: 28px;
          margin: 0 0 11px;
        ">One of DHH members will be in touch with you shortly. If you have any additional requirements or questions, please do not hesitate to contact us.</p>
        <button style="
          height: 48px;
          width: 174px;
          border-radius: 2px;
        ...
        ">
          ...
          border: none;
        ">
              <a href="<?php echo BASE_URL . View::url('index.php/tools/print_receipt?bookingNo=' . $booking->getBookingNo());?>" style="
            color: #FFFFFF;
            font-family: Roboto;
            font-size: 16px;
            font-weight: 500;
