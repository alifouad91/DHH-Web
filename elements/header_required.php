...
if ($property && ($property instanceof Property)) {
	$escapedPageTitle = $property->getName() . ' | ' . SITE;
	$akd              = $property->getDescription();
}
...
<?php $u = new User(); ?>
    <script type="text/javascript">
        ...
        var CCM_BASE_TOOLS_PATH = "<?php echo REL_DIR_FILES_TOOLS?>";
        var CCM_BASE_URL = "<?php echo BASE_URL?>";
        var CCM_REL = "<?php echo DIR_REL?>";
        var CHAT_PORT = "<?php echo CHAT_PORT?>";
        var CCM_SITE = <?php echo $jsonHelper->encode(SITE); ?>;
        var CCM_IS_USER_LOGGED_IN = <?php echo User::isLoggedIn() ? 1 : 0 ?>
